...
router.post("/create_payment_url", async (req, res) => {
  try {
    ...
    console.log("vnp_Url:", vnp_Url, "vnp_ReturnUrl:", vnp_ReturnUrl, "vnp_TmnCode:", vnp_TmnCode, "vnp_HashSecret:", vnp_HashSecret);
...
const amountVND = Math.round(amount * 100); // 8999 VND

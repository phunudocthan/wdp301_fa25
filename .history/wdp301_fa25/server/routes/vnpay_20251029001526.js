...
const vnp_TmnCode = "YOUR_TMN_CODE";       // Mã website VNPay
const vnp_HashSecret = "YOUR_SECRET_KEY";  // Secret key
const vnp_Url = "https://sandbox.vnpayment.vn/paymentv2/vpcpay.html";
const vnp_ReturnUrl = "http://localhost:3000/vnpay-return"; // URL callback

...
// 🔹 Hàm convert amount sang VND nguyên, tối thiểu 5000
function convertAmount(amount) {
  let amountVND = Math.round(amount)*23000;
  if (amountVND < 5000) amountVND = 5000;
  return amountVND;
}

// 🔹 Hàm tạo vnp_TxnRef hợp lệ
function createTxnRef(orderId) {
  ...
  return `${cleanOrderId}${timestamp}`; // 6900e9aa15e5b7d6770f53b9176549
}
...
router.post("/create_payment_url", async (req, res) => {
  try {
    ...
    const amountVND = convertAmount(amount);

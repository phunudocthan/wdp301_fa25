                ...
                <Descriptions.Item label="Shipping">
                  {(() => {
                    ...
                    if (fullAddr) {
                      return (
                        <div>
                          <div style={{ fontWeight: 600 }}>{fullAddr}</div>
                          {name && <div>{name}</div>}
                          {phone && <div>{phone}</div>}
                    ...
                    return <Empty description="No shipping address" />;
                  })()}
                </Descriptions.Item>
                ...
                renderItem={(item) => (
                  <List.Item>
                    <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
                      { (item.image || item.legoId?.images?.[0]) ? (
                        <img
                          src={item.image || item.legoId?.images?.[0]}
                          alt={item.name || item.legoId?.name}

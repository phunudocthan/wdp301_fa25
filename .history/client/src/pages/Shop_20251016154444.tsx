...
export default function Shop() {
  ...
  const [_themes, _setThemes] = useState<any[]>([]);
  ...
  // query param read intentionally omitted here; searchTerm and location.search are used instead
  ...
  _setThemes(res.data.data.themes || []);
  ...
  // location.search is used directly where needed
        error?.message ||
                  ...
                  <Popover
                    ...
                    content={
                      <div style={{ width: 300, padding: 10 }}>
                        ...
                        <p style={{ fontSize: 13, color: (p.stock || 0) > 0 ? "#28a745" : "#dc3545", marginBottom: 10 }}>

...
import Login from "./../src/components/LegoLoginPage";
...
function AppContent() {
  ...
  // Employee: chỉ EmployeeHeader + /employee/news
  if (isEmployee) {
    return (
      <div>
        <EmployeeHeader />
    ...
    <div>
      ...
      <main>
        <Routes>
          ...
          <Route path="/orders/:id" element={redirectIfAdmin(<OrderDetailUser />)} />
